  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className={`absolute bottom-40 left-1/3 w-96 h-96 rounded-full blur-3xl opacity-5 ${
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                I am a passionate developer with a mission to create impactful
                solutions through code. My journey has been fueled by curiosity
                and a desire to learn, and I am committed to continuous growth
            ...
            <motion.div variants={itemVariants} className="text-center py-8">
              ...
              <div className="flex justify-center">
                <img src={SIGNATURE} alt="Tannie" className="w-28" />
              </div>
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-blue hover:bg-blue-600 text-white px-8 py-3 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300"
            >
              Let's Work Together
            </motion.button>
          </motion.div>
