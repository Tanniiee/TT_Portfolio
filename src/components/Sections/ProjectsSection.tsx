    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            A collection of projects that showcase my expertise in web and
            application development, design, and problem-solving. Each project
            highlights my skills and creativity in delivering effective
            solutions.
          </motion.p>
        </motion.div>
