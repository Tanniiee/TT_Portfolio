    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            A comprehensive overview of my technical skills, categorized by
        ...
        >
          {(SKILLS_CATEGORY as SkillCategory[]).map((category: SkillCategory, categoryIndex: number) => (
            <motion.div
              key={category.title}
              variants={itemVariants}
        ...
        >
          ...
          >
            {(TECH_STACK as string[]).map((tech: string, index: number) => (
              <motion.span
                key={tech}
        ...
        >
          {(STATS as Stat[]).map((stat: Stat, index: number) => (
            <motion.div
              key={stat.label}
              variants={itemVariants}
